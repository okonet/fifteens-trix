   ...
   function Touchable(elem, conf)
   {
     ...
     function touchstart (e) {
       if(typeof e.touches!== "undefined")
         ...
         log('Touchable Touchstart touches length ' + e.pageX + ' ' + e.pageY);			  
   				...
   				$(document.body).bind('mousemove', touchmove);
   				$(document.body).bind('mouseup', touchend);  							  
  		}
     ...
     function touchend(e) {
       if (typeof e.touches !== 'undefined'){
     		...
     		$(document.body).unbind('mousemove',touchmove);
     		$(document.body).unbind('mouseup',touchend);      					  
  		}
